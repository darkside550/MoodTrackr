...
export default function Dashboard() {
  ...
  async function handleSetMood(mood) {
    ...
    try {
      ...
      // the {merge: true} option means that it will merge the new data with the existing data
      // so if the document already exists, it will only update the fields that are present in the new data
